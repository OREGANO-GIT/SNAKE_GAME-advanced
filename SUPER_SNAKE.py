    ...
    if (x + width > cursor[0] > x and y + height > cursor[1] > y):
        ...
        if click[0] == 1 and action != None:
            if action == 'play' or action == 'again':
                ...
                ret=pyautogui.confirm("Do you really want to quit?")
                if(ret=="OK"):
                    pygame.quit()
                    pygame.font.quit()
                    quit()
                ...
                if(text=='SUBMIT'):
                    webbrowser.open('https://docs.google.com/forms/d/e/1FAIpQLSeje7DjXECVVcLoKZCNBxw4is85h2zzMZqv2oGbMkZWJv-v1w/viewform?usp=sf_link',new=1)
                if(text=='L-BOARD'):
                    webbrowser.open('https://docs.google.com/spreadsheets/d/1vlVcjYeMIuTRqAigL_KxfEXidMXuk4AKAeED6W5h3Rk/edit?usp=sharing',new=2)
    else:
...
def show_controls():
    ...
    while True:
        ...
        draw_text("Be careful not to hit walls and suddenly appearing", czarny, 28, display_width/2, display_height/2 -50)
...
def show_controls_next():
    ...
    while True:
        ...
        draw_text("     will make snake shorter and easier to manouver.", czarny, 28, display_width/2, display_height/2 -70)
...
def gameLoop(): 
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            button("SUBMIT", 225, 365, 200, 70, czerwony, LIGHT_RED, action = 'url')
            button("L-BOARD", 475, 365, 200, 70, czerwony, LIGHT_RED, action = 'url')
